        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {SERVICES.map((service, i) => (
            <Reveal key={service.title} delay={i * 80}>
              <div className="card flex h-full flex-col gap-3.5 p-7 transition hover:border-trust-600/30">
                <span
                  className={`flex h-10 w-10 items-center justify-center rounded-[10px] text-white ${service.tint}`}
                >
